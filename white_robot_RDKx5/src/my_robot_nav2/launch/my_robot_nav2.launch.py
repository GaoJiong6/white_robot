...
def generate_launch_description():
    ...
    turn_on_robot_dir = get_package_share_directory('turn_on_robot')
    turn_on_launch_dir = os.path.join(turn_on_robot_dir, 'launch')
        
    my_nav_dir = get_package_share_directory('my_robot_nav2')
    my_launch_dir = os.path.join(my_nav_dir, 'launch')
    my_map_dir = os.path.join(my_nav_dir, 'map')
    my_map_file = 'White_robot.yaml'
    ...
    my_param_dir = os.path.join(my_nav_dir, 'param','white_robot_param')
    ...
    turn_on_robot = IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(turn_on_launch_dir, 'turn_on_robot.launch.py')),
    )
    turn_on_lidar = IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(turn_on_launch_dir, 'lidar.launch.py')),
    )
    # Specify the actions
